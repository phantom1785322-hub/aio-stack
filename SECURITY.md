...
1. Go to the [Security tab](https://github.com/aio-stack/aio-stack/security)
2. Click "Report a vulnerability"
3. Fill out the form with details

**Alternative: Email**
- Email: security@aio-stack.dev
...
brew upgrade aio-stack        # macOS/Linux
scoop update aio-stack        # Windows
# Or re-run installer
...
- Use `AIO_STACK_GITHUB_TOKEN`, `AIO_STACK_GITLAB_TOKEN` env vars
...
- Review plugin permissions before installing
- Prefer official plugins (`aio-stack/`)
- Check `aio-stack plugin list` regularly
...
- **Primary**: security@aio-stack.dev
